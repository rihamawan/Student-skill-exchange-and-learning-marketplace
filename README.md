...
| File | Role |
|------|------|
| `schema.sql` | Schema + triggers + views + baseline indexes |
| `seed.sql` | Sample data |
| `performance.sql` | EXPLAIN / ANALYZE + optional extra indexes |
| `acid_transactions.sql` | ACID demos / stored procedures |

---

## Appendix: evaluation checklist alignment

This README is intended to satisfy: overview, tech stack, architecture, setup, env vars, DB init, roles & credentials, features, transactions, ACID, indexing/performance, API summary, known issues, and scripts — without requiring readers to infer behaviour only from source code. Section 4 images: `./media/ui-RequestedSkills.png`, `./media/ui-OfferedSkills.png`, `./media/ui-conversations.png`.
